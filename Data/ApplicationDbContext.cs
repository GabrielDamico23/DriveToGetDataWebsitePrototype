    ...
    public class ApplicationDbContext(DbContextOptions<ApplicationDbContext> options) : IdentityDbContext<ApplicationUser>(options)
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Driver>().HasData(
                new Driver { DriverId = "hamilton", GivenName = "Lewis", FamilyName = "Hamilton", PermanentNumber = 44, Nationality = "British", DateOfBirth = "1985-01-07", Url = "http://en.wikipedia.org/wiki/Lewis_Hamilton" },
                new Driver { DriverId = "bottas", GivenName = "Valtteri", FamilyName = "Bottas", PermanentNumber = 77, Nationality = "Finnish", DateOfBirth = "1989-08-28", Url = "http://en.wikipedia.org/wiki/Valtteri_Bottas" },
                new Driver { DriverId = "max_verstappen", GivenName = "Max", FamilyName = "Verstappen", PermanentNumber = 1, Nationality = "Dutch", DateOfBirth = "1997-09-30", Url = "http://en.wikipedia.org/wiki/Max_Verstappen" },
                new Driver { DriverId = "perez", GivenName = "Sergio", FamilyName = "Perez", PermanentNumber = 11, Nationality = "Mexican", DateOfBirth = "1990-01-26", Url = "http://en.wikipedia.org/wiki/Sergio_P%C3%A9rez" },
                new Driver { DriverId = "norris", GivenName = "Lando", FamilyName = "Norris", PermanentNumber = 4, Nationality = "British", DateOfBirth = "1999-11-13", Url = "http://en.wikipedia.org/wiki/Lando_Norris" },
                new Driver { DriverId = "ricciardo", GivenName = "Daniel", FamilyName = "Ricciardo", PermanentNumber = 3, Nationality = "Australian", DateOfBirth = "1989-07-01", Url = "http://en.wikipedia.org/wiki/Daniel_Ricciardo" },
                new Driver { DriverId = "sainz", GivenName = "Carlos", FamilyName = "Sainz", PermanentNumber = 55, Nationality = "Spanish", DateOfBirth = "1994-09-01", Url = "http://en.wikipedia.org/wiki/Carlos_Sainz_Jr." },
                new Driver { DriverId = "leclerc", GivenName = "Charles", FamilyName = "Leclerc", PermanentNumber = 16, Nationality = "Monegasque", DateOfBirth = "1997-10-16", Url = "http://en.wikipedia.org/wiki/Charles_Leclerc" },
                new Driver { DriverId = "piastri", GivenName = "Oscar", FamilyName = "Piastri", PermanentNumber = 81, Nationality = "Australian", DateOfBirth = "2001-04-06", Url = "http://en.wikipedia.org/wiki/Oscar_Piastri" },
                new Driver { DriverId = "russell", GivenName = "George", FamilyName = "Russell", PermanentNumber = 63, Nationality = "British", DateOfBirth = "1998-02-15", Url = "http://en.wikipedia.org/wiki/George_Russell_(racing_driver)" },
                new Driver { DriverId = "alonso", GivenName = "Fernando", FamilyName = "Alonso", PermanentNumber = 14, Nationality = "Spanish", DateOfBirth = "1981-07-29", Url = "http://en.wikipedia.org/wiki/Fernando_Alonso" },
                new Driver { DriverId = "ocon", GivenName = "Esteban", FamilyName = "Ocon", PermanentNumber = 31, Nationality = "French", DateOfBirth = "1996-09-17", Url = "http://en.wikipedia.org/wiki/Esteban_Ocon" },
                new Driver { DriverId = "hulkenberg", GivenName = "Nico", FamilyName = "Hulkenberg", PermanentNumber = 27, Nationality = "German", DateOfBirth = "1987-08-19", Url = "http://en.wikipedia.org/wiki/Nico_H%C3%BClkenberg" },
                new Driver { DriverId = "stroll", GivenName = "Lance", FamilyName = "Stroll", PermanentNumber = 18, Nationality = "Canadian", DateOfBirth = "1998-10-29", Url = "http://en.wikipedia.org/wiki/Lance_Stroll" },
                new Driver { DriverId = "tsunoda", GivenName = "Yuki", FamilyName = "Tsunoda", PermanentNumber = 22, Nationality = "Japanese", DateOfBirth = "2000-05-11", Url = "http://en.wikipedia.org/wiki/Yuki_Tsunoda" },
                new Driver { DriverId = "gasly", GivenName = "Pierre", FamilyName = "Gasly", PermanentNumber = 10, Nationality = "French", DateOfBirth = "1996-02-07", Url = "http://en.wikipedia.org/wiki/Pierre_Gasly" },
                new Driver { DriverId = "bearman", GivenName = "Oliver", FamilyName = "Bearman", PermanentNumber = 50, Nationality = "British", DateOfBirth = "2005-05-08", Url = "http://en.wikipedia.org/wiki/Oliver_Bearman" },
                new Driver { DriverId = "kevin_magnussen", GivenName = "Kevin", FamilyName = "Magnussen", PermanentNumber = 20, Nationality = "Danish", DateOfBirth = "1992-10-05", Url = "http://en.wikipedia.org/wiki/Kevin_Magnussen" },
                new Driver { DriverId = "colapinto", GivenName = "Franco", FamilyName = "Colapinto", PermanentNumber = 43, Nationality = "Argentinian", DateOfBirth = "2003-05-27", Url = "http://en.wikipedia.org/wiki/Franco_Colapinto" },
                new Driver { DriverId = "mick_schumacher", GivenName = "Mick", FamilyName = "Schumacher", PermanentNumber = 47, Nationality = "German", DateOfBirth = "1999-03-22", Url = "http://en.wikipedia.org/wiki/Mick_Schumacher" },
                new Driver { DriverId = "vettel", GivenName = "Sebastian", FamilyName = "Vettel", PermanentNumber = 5, Nationality = "German", DateOfBirth = "1987-07-03", Url = "http://en.wikipedia.org/wiki/Sebastian_Vettel" },
                new Driver { DriverId = "latifi", GivenName = "Nicholas", FamilyName = "Latifi", PermanentNumber = 6, Nationality = "Canadian", DateOfBirth = "1995-06-29", Url = "http://en.wikipedia.org/wiki/Nicholas_Latifi" },
                new Driver { DriverId = "zhou", GivenName = "Guanyu", FamilyName = "Zhou", PermanentNumber = 24, Nationality = "Chinese", DateOfBirth = "1999-05-30", Url = "http://en.wikipedia.org/wiki/Zhou_Guanyu" },
                new Driver { DriverId = "sargeant", GivenName = "Logan", FamilyName = "Sargeant", PermanentNumber = 2, Nationality = "American", DateOfBirth = "2000-12-31", Url = "http://en.wikipedia.org/wiki/Logan_Sargeant" },
                new Driver { DriverId = "albon", GivenName = "Alexander", FamilyName = "Albon", PermanentNumber = 23, Nationality = "Thai", DateOfBirth = "1996-03-23", Url = "http://en.wikipedia.org/wiki/Alexander_Albon" },
                new Driver { DriverId = "de_vries", GivenName = "Nyck", FamilyName = "de Vries", PermanentNumber = 7, Nationality = "Dutch", DateOfBirth = "1995-02-06", Url = "http://en.wikipedia.org/wiki/Nyck_de_Vries" },
                new Driver { DriverId = "lawson", GivenName = "Liam", FamilyName = "Lawson", PermanentNumber = 36, Nationality = "New Zealander", DateOfBirth = "2002-02-11", Url = "http://en.wikipedia.org/wiki/Liam_Lawson" }
            );
